...
- Allow anon + authenticated INSERT only (visitors can submit the contact form).
- No SELECT/UPDATE/DELETE for anon — only the portfolio owner should read messages server-side.
*/
